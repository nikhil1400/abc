...
try:
    ...
    for i in range(Num_flasher):
		...
		hardwareType = "PrimeJrBattery"
		writer.writerow(('3', '10', '55', 'ed8b4ccf9c1876f233ff0dc5c5d2b76a2b3cae87', '9600',
                         'none', '0', '1', '2',
                         '115200', '11', '0', pins[i], 'US',
                         '10', 'LightBulb-010203', '2D', 'jssdev', 'FirstAlert', 'DC10',
                         'Onelink Alarm', serialNumber, '2.0', 'acc_info:pairing:proto_info:smoke:co:onelink:firmware:battery', '3E',
                         '1', 'name:manufacturer:model:serial_no:identify:fw_rev:prop:srv_inst', '23', '2', '2',
                         '20', '2', '3', '21',
                         '2', '4', '30', '2',
                         '5', '14', '8', '6',
                         '52', '2', '7', 'A6', '26',
                         '49', 'E604E95DA759481787D3AA005083A0D1', '2', '50',

                         '55', '9', 'pair_setup:pair_verify:features:pairings:srv_inst', '4c', 'a',
                         '10', '4e', 'a', '11',
                         '4f', '2', '12', '50',
                         'a', '13', 'E604E95DA759481787D3AA005083A0D1', '2',
                         '51', 'A2', '52', 'version:srv_inst', '37',
                         '2', '53', 'E604E95DA759481787D3AA005083A0D1', '2',
                         '54', ':f5dd917b920128f4a0ede8e41108c10d1267466794165a73d918747c2f8ca70d',
