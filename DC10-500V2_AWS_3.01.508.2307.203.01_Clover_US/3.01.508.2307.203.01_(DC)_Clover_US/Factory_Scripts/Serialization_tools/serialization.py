...
############################# Configuration ##########################
port = "COM10" #Please Change COM Port Here
baudrate = 9600
Serialization_config_path = "./config"
######################################################################
...
print ""
print "Starting Serialization Process... for Serial Number:" + serialNumber
print ""
...
print "Firmware version... from PIC"
ser.write("RF\r")
time.sleep(delay)
while ser.inWaiting() == 0:
	pass
...
print "Writing/Reading Model... from PIC"
printModel = '1042136'
...
print "NOT Provisioning the Device on Cloud..."
#while True:
#    try:
